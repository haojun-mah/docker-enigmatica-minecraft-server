...
Last README file update: Sun Nov 30 07:53:01 GMT 2025
...
command.eu
command.eu.aura
command.eu.aura.amount
command.eu.aura.amount.maxTarget
command.evilcraft
...
command.salemraid
command.salemraid.tier
command.salemraid.tier.destination
command.salemraid.tier.location
command.save-all
